...
export default function App() {
  const accountAccess = [
    { 
      ...
      desc: "Check your restored square meters.",
    ...
    { 
      ...
      desc: "Resume your conservation goals.",
    ...
    { 
      ...
      desc: "Your footprints are encrypted.",
  ...
  return (
    <main className="relative w-full h-svh bg-[#050609] font-sans text-white overflow-x-hidden overflow-y-auto selection:bg-indigo-500/30 scrollbar-hide">
      ...
      <div className="relative z-10 flex flex-col w-full min-h-full pb-[60px]">
        {/* HERO SECTION - Jerarquía sincronizada */}
        <section className="px-6 md:px-0 pt-28 md:pt-40 pb-12 md:pb-20 max-w-7xl mx-auto w-full text-center">
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-[11px] font-bold uppercase tracking-wider text-blue-400 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 hover:bg-white/10 transition-colors cursor-default">
            <LogIn size={14} />
            Secure Access
          </div>
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-medium tracking-tight leading-[0.95] mb-8 md:mb-10 animate-in fade-in slide-in-from-top-4 duration-1000">
            Welcome <br /> <span className="text-white/40 italic font-light hover:text-white transition-colors duration-500 cursor-default">back today</span>
          </h1>
          <p className="text-white/60 text-base sm:text-2xl md:text-2xl font-light leading-relaxed max-w-3xl mx-auto tracking-tight animate-in fade-in duration-1000 delay-300">
            Log in to manage your regenerative expeditions and track your positive footprint across the globe.
          </p>
        </section>

        {/* LOG IN FORM SECTION - Estructura sincronizada con Sign Up */}
        <section className="px-4 md:px-16 py-12 md:py-20 w-full max-w-7xl mx-auto md:bg-white/[0.01] md:rounded-[80px] md:border md:border-white/5 shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            {/* Benefits Side - Jerarquía móvil optimizada */}
            <div className="lg:col-span-5 space-y-12 order-2 lg:order-1 pt-4">
              <div className="space-y-8">
                <h3 className="text-xs uppercase tracking-wider text-white/30 font-bold">Earthly Access</h3>
                <div className="space-y-8">
                  {accountAccess.map((b, i) => (
              ...
              <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[35px] md:rounded-[45px] space-y-4 shadow-xl">
                <p className="text-sm font-light leading-relaxed italic text-white/40">
                  &quot;Your account ensures that every regenerative action is tracked and verified by the community.&quot;
                </p>
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-blue-400">
                  <div className="w-6 h-[1px] bg-blue-400/30" />
                  Verified Identity
                </div>
              </div>
            </div>

            {/* Form Side - Espaciado y botones unificados */}
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="bg-[#0a0b10] border border-white/10 rounded-[40px] md:rounded-[50px] p-8 md:p-14 shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-500/5 blur-[100px] rounded-full -mr-48 -mt-48 transition-opacity pointer-events-none" />
                ...
                <form className="relative z-10 space-y-10" onSubmit={(e) => e.preventDefault()}>
                  <div className="flex flex-col">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-[22px] py-5 pl-16 pr-6 text-sm focus:outline-none focus:border-blue-500/50 focus:bg-white/[0.08] transition-all placeholder:text-white/10"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-between items-center pr-4 mb-4">
                      <label className="text-xs uppercase tracking-wide text-white/40 ml-4 font-bold">Security Phrase</label>
                      <Link href="/recover" className="text-[9px] uppercase tracking-widest text-white/20 hover:text-white transition-colors no-underline">Forgot?</Link>
                    </div>
                    <div className="relative">
                  ...
                  <p className="text-center text-xs md:text-sm text-white/30 pt-8">
                    New to Earthly? <Link href="/sign-up" className="text-blue-400 hover:text-blue-300 font-bold transition-colors no-underline ml-1">Create Account</Link>
                  </p>
                </form>
              </div>
            </div>
        ...
        <section className="px-6 py-12 md:py-24 text-center max-w-7xl mx-auto w-full">
          <div className="w-px h-16 bg-gradient-to-b from-blue-500 to-transparent mx-auto mb-10 md:mb-12 opacity-50 transition-all duration-1000" />
          <h2 className="text-3xl md:text-6xl font-medium tracking-tight mb-8">Secure Environment</h2>
          <p className="text-white/30 text-base md:text-xl font-light mb-12 italic hover:text-white/50 transition-colors cursor-default max-w-3xl mx-auto px-4">
            &quot;Returning to the wild requires more than just being there; it requires responsibility and intent.&quot;
          </p>
        </section>
      </div>
